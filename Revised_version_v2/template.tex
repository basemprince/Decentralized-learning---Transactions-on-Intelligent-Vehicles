...
\usepackage{balance}
\begin{document}
\title{Generation of Vehicle Sensor Data with Decentralized Generative Adversarial Network}
\author{Basem Shaker$^{1}$, Gastone Pietro Rosati Papini$^{1}$, Matteo Saveriano$^{1}$ 
\thanks{$^{1}$B. Shaker, G.P. Rosati Papini, M. Saveriano are with the Department of Industrial Engineering, University of Trento, Trento, Italy ({\footnotesize{\tt gastone.rosatipapini@unitn.it}}).}}
...
\begin{IEEEkeywords}
Generative Adversarial Network, Decentralized Learning, Vehicle Data
\end{IEEEkeywords}


\section{Introduction}
\IEEEPARstart{I}{ndroduction} to the main concepts. The thesis "Introduction" 1/1.5 columns.

\section{Related Works}
Here we summarize the "Literature Review" section of the thesis. 1/1.5 columns.
...
\subsection{Neural Network Model Type}
The "Network Size Consideration" can be moved in the Appendix. If there will be.
\subsection{Time-series Based Neural Network Architecture}
Some notes on the "Image Based Neural Network Architecture".
\subsubsection{Dynamic Window Implementation}

\section{Decentralized Training Strategies}
All this section will be 1/2 pages.
\subsection{Data-set Pre-processing}
\subsection{Loss Function}
\subsection{Training Optimizer}
\subsection{Training Sequence}

\section{Results of Decentralized GANs}
All this section will be 1/2 pages.
\subsection{Time-Series Based GAN Results}

\section{Conclusion and Future Work}
1/1.5 columns.

\section{All the other section can be used as template informations}
